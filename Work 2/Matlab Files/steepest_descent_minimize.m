function [k] = steepest_descent_minimize(x1,y1,epsilon)
syms x y
...
figure(3);
plot(1:k-1, gamma_k, '-o', 'LineWidth', 2, 'MarkerSize', 6);
xlabel('Αριθμός Επαναλήψεων k');
ylabel(' γκ');
title('Μεταβολή του γκ ως προς k');
grid on;
end
